...
![Version: 0.16.14](https://img.shields.io/badge/Version-0.16.14-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| frontend.image.tag | string | `"v3.0.2"` | Frontend version. |
