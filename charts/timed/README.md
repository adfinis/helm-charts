...
![Version: 0.16.31](https://img.shields.io/badge/Version-0.16.31-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| frontend.image.tag | string | `"v3.4.0"` | Frontend version. |
