...
![Version: 0.16.15](https://img.shields.io/badge/Version-0.16.15-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| backend.image.tag | string | `"v3.0.3"` | Backend version. |
