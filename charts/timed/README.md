...
![Version: 0.16.13](https://img.shields.io/badge/Version-0.16.13-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| backend.image.tag | string | `"v3.0.2"` | Backend version. |
...
| frontend.image.tag | string | `"v3.0.1"` | Frontend version. |
