...
| backend.cronjobs.notifyChangedEmployments | object | `{"command":["poetry run python manage.py","notify_changed_employments"],"schedule":"0 2 * * 1"}` | Notify changed employments |
| backend.cronjobs.notifyReviewersFirst | object | `{"command":["poetry run python manage.py","notify_reviewers_unverified","--offset","5"],"schedule":"0 8 4 * *"}` | Notify reviewers first stage |
| backend.cronjobs.notifyReviewersFirst.command[3] | string | `"5"` | Period will end today minus given offset |
| backend.cronjobs.notifyReviewersSecond | object | `{"command":["poetry run python manage.py","notify_reviewers_unverified","--offset","12","--message","'Please verify your reports.'"],"schedule":"0 8 11 * *"}` | Notify reviewers second stage |
...
| backend.cronjobs.notifyReviewersThird | object | `{"command":["poetry run python manage.py","notify_reviewers_unverified","--offset","19","--message","'Please verify your reports immediately!'"],"schedule":"0 8 18 * *"}` | Notify reviewers third stage |
...
| backend.cronjobs.notifySupervisors | object | `{"command":["poetry run python manage.py","notify_supervisors_shorttime"],"schedule":"0 8 * * 4"}` | Notify supervisors |
| backend.cronjobs.redmineReport | object | `{"command":["poetry run python manage.py","redmine_report"],"schedule":"0 1 * * 1"}` | Redmine report |
