...
![Version: 0.16.23](https://img.shields.io/badge/Version-0.16.23-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| backend.image.tag | string | `"v3.0.5"` | Backend version. |
