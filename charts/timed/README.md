...
![Version: 0.16.35](https://img.shields.io/badge/Version-0.16.35-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| backend.image.tag | string | `"v3.0.12"` | Backend version. |
...
| frontend.image.tag | string | `"v3.5.0"` | Frontend version. |
