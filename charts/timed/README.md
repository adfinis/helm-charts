...
![Version: 0.16.30](https://img.shields.io/badge/Version-0.16.30-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| frontend.image.tag | string | `"v3.3.0"` | Frontend version. |
