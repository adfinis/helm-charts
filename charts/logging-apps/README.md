...
| fluentBit.targetRevision | string | `"0.58.1"` | [fluent-bit Helm chart](https://github.com/fluent/helm-charts/tree/main/charts/fluent-bit) version |
...
| fluentd.targetRevision | string | `"7.2.6"` | [fluentd Helm chart](https://github.com/bitnami/charts/tree/master/bitnami/fluentd) version |
...
| loki.targetRevision | string | `"18.12.1"` | [loki Helm chart](https://github.com/grafana-community/helm-charts/tree/main/charts/loki) |
...
| promtail.targetRevision | string | `"6.17.1"` | [promtail Helm chart](https://github.com/grafana/helm-charts/tree/main/charts/promtail) |
