...
| filebeat.targetRevision | string | `"8.5.*"` | [filebeat Helm chart](https://github.com/elastic/helm-charts/tree/master/filebeat) version |
...
| lokiStack.targetRevision | string | `"2.8.*"` | [loki-stack Helm chart](https://github.com/grafana/helm-charts/tree/main/charts/loki-stack) version |
