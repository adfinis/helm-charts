...
| argocdApps.targetRevision | string | `"2.0.3"` | [argocd-apps Helm chart](https://github.com/argoproj/argo-helm/tree/main/charts/argocd-apps) version |
...
| opencost.targetRevision | string | `"2.5.3"` | [OpenCost Helm chart](https://github.com/opencost/opencost-helm-chart/tree/main/charts/opencost) |
