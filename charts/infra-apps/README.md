...
| argocd.targetRevision | string | `"3.3.*"` | [argo-cd Helm chart](https://github.com/argoproj/argo-helm/tree/master/charts/argo-cd) version |
...
| argocdNotifications.targetRevision | string | `"1.0.*"` | [argo-cd Helm chart](https://github.com/argoproj/argo-helm/tree/master/charts/argocd-notifications) version |
...
| thanos.targetRevision | string | `"3.16.*"` | [Thanos Helm chart](https://github.com/bitnami/charts/tree/master/bitnami/thanos) |
...
| velero.targetRevision | string | `"2.18.*"` | [Velero Helm chart](https://github.com/vmware-tanzu/helm-charts/tree/main/charts/velero) |
