...
![Version: 0.248.0](https://img.shields.io/badge/Version-0.248.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| argocd.targetRevision | string | `"8.3.1"` | [argo-cd Helm chart](https://github.com/argoproj/argo-helm/tree/main/charts/argo-cd) version |
...
| certManager.targetRevision | string | `"1.18.2"` | [cert-manager Helm chart](https://github.com/cert-manager/cert-manager/tree/master/deploy/charts/cert-manager) version |
...
| certManagerMonitoring.targetRevision | string | `"0.2.0"` | [cert-manager-monitoring Helm chart](https://github.com/adfinis/helm-charts/tree/main/charts/cert-manager-monitoring) version |
