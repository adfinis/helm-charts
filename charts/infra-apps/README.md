...
![Version: 0.251.0](https://img.shields.io/badge/Version-0.251.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| certManagerMonitoring.targetRevision | string | `"0.3.0"` | [cert-manager-monitoring Helm chart](https://github.com/adfinis/helm-charts/tree/main/charts/cert-manager-monitoring) version |
