...
![Version: 0.163.1](https://img.shields.io/badge/Version-0.163.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| argocd.targetRevision | string | `"5.36.2"` | [argo-cd Helm chart](https://github.com/argoproj/argo-helm/tree/main/charts/argo-cd) version |
...
| certManager.targetRevision | string | `"1.12.2"` | [cert-manager Helm chart](https://github.com/cert-manager/cert-manager/tree/master/deploy/charts/cert-manager) version |
...
| ingressNginx.targetRevision | string | `"4.6.0"` | [ingress-nginx Helm chart](https://github.com/kubernetes/ingress-nginx/tree/main/charts/ingress-nginx) version |
...
| kubePrometheusStack.targetRevision | string | `"45.23.0"` | [kube-prometheus-stack Helm chart](https://github.com/prometheus-community/helm-charts/tree/main/charts/kube-prometheus-stack) version |
...
| kured.targetRevision | string | `"4.2.0"` | [Kured Helm chart](https://github.com/kubereboot/charts/tree/main/charts/kured) |
...
| rbacManager.targetRevision | string | `"1.15.1"` | [rbac-manager operator Helm chart](https://github.com/FairwindsOps/charts/tree/master/stable/rbac-manager) version |
...
| velero.targetRevision | string | `"4.0.2"` | [Velero Helm chart](https://github.com/vmware-tanzu/helm-charts/tree/main/charts/velero) |
