...
![Version: 0.276.0](https://img.shields.io/badge/Version-0.276.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| kured.targetRevision | string | `"6.1.0"` | [Kured Helm chart](https://github.com/kubereboot/charts/tree/main/charts/kured) |
...
| rbacManager.targetRevision | string | `"2.0.0"` | [rbac-manager operator Helm chart](https://github.com/FairwindsOps/charts/tree/master/stable/rbac-manager) version |
