...
![Version: 0.261.0](https://img.shields.io/badge/Version-0.261.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| certManager.targetRevision | string | `"1.19.2"` | [cert-manager Helm chart](https://github.com/cert-manager/cert-manager/tree/master/deploy/charts/cert-manager) version |
