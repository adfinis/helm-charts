...
![Version: 0.188.0](https://img.shields.io/badge/Version-0.188.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| velero.targetRevision | string | `"5.1.0"` | [Velero Helm chart](https://github.com/vmware-tanzu/helm-charts/tree/main/charts/velero) |
