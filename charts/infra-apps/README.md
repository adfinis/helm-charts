...
![Version: 0.152.0](https://img.shields.io/badge/Version-0.152.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| argocd.targetRevision | string | `"5.26.0"` | [argo-cd Helm chart](https://github.com/argoproj/argo-helm/tree/main/charts/argo-cd) version |
