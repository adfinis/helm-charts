...
| argocd.targetRevision | string | `"3.22.*"` | [argo-cd Helm chart](https://github.com/argoproj/argo-helm/tree/master/charts/argo-cd) version |
...
| certManager.targetRevision | string | `"1.5.*"` | [cert-manager Helm chart](https://github.com/jetstack/cert-manager/tree/master/deploy/charts/cert-manager) version |
...
| ingressNginx.targetRevision | string | `"3.34.*"` | [ingress-nginx Helm chart](https://github.com/kubernetes/ingress-nginx/tree/master/charts/ingress-nginx) version |
...
| kubeEventExporter.targetRevision | string | `"1.1.*"` | [kubernetes-event-exporter Helm chart](https://github.com/bitnami/charts/tree/master/bitnami/kubernetes-event-exporter) |
...
| kubePrometheusStack.targetRevision | string | `"18.0.*"` | [kube-prometheus-stack Helm chart](https://github.com/prometheus-community/helm-charts/tree/main/charts/kube-prometheus-stack) version |
...
| kured.targetRevision | string | `"2.9.*"` | [Kured Helm chart](https://github.com/weaveworks/kured/tree/main/charts/kured) |
