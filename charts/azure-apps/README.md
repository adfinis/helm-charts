...
| promitorResourceDiscovery.targetRevision | string | `"0.14.1"` | [promitor-agent-resource-discovery Helm chart](https://github.com/promitor/charts/tree/main/promitor-agent-resource-discovery) version |
