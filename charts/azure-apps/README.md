...
| promitorResourceDiscovery.targetRevision | string | `"0.11.1"` | [promitor-agent-resource-discovery Helm chart](https://github.com/promitor/charts/tree/main/promitor-agent-resource-discovery) version |
...
| promitorScraper.targetRevision | string | `"2.12.1"` | [promitor-agent-scraper Helm chart](https://github.com/promitor/charts/tree/main/promitor-agent-scraper) version |
