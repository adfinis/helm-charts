...
| promitorResourceDiscovery.targetRevision | string | `"0.16.1"` | [promitor-agent-resource-discovery Helm chart](https://github.com/promitor/charts/tree/main/promitor-agent-resource-discovery) version |
...
| promitorScraper.targetRevision | string | `"2.16.1"` | [promitor-agent-scraper Helm chart](https://github.com/promitor/charts/tree/main/promitor-agent-scraper) version |
