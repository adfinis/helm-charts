...
![Version: 0.134.0](https://img.shields.io/badge/Version-0.134.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| oauth2Proxy.targetRevision | string | `"10.6.0"` | [oauth2-proxy Helm chart](https://github.com/oauth2-proxy/manifests/tree/main/helm/oauth2-proxy) |
...
| vault.targetRevision | string | `"0.34.0"` | [vault Helm chart](https://github.com/hashicorp/vault-helm) version |
