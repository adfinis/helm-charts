...
| falco.targetRevision | string | `"1.13.*"` | [falco Helm chart](https://github.com/falcosecurity/charts/tree/master/falco) version |
...
| gatekeeper.targetRevision | string | `"3.5.*"` | [gatekeeper Helm chart](https://github.com/open-policy-agent/gatekeeper/tree/master/charts/gatekeeper) version |
