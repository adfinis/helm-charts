...
| falco.targetRevision | string | `"1.16.*"` | [falco Helm chart](https://github.com/falcosecurity/charts/tree/master/falco) version |
...
| falcoExporter.targetRevision | string | `"0.7.*"` | [falco Helm chart](https://github.com/falcosecurity/charts/tree/master/falco-exporter) version |
...
| secretsStoreCsiDriver.targetRevision | string | `"1.1.*"` | [vault-csi-provider Helm chart](https://github.com/kubernetes-sigs/secrets-store-csi-driver/blob/main/charts/secrets-store-csi-driver) version |
...
| vault.targetRevision | string | `"0.18.*"` | [vault Helm chart](https://github.com/hashicorp/vault-helm) version |
