...
| secretsStoreCsiDriver.targetRevision | string | `"1.2.4"` | [secrets-store-csi-driver Helm chart](https://github.com/kubernetes-sigs/secrets-store-csi-driver/blob/main/charts/secrets-store-csi-driver) version |
...
| stackroxCentralServices.targetRevision | string | `"73.1.0"` | [stackrox/central-services Helm chart](https://github.com/stackrox/helm-charts/tree/main/opensource) version |
...
| stackroxSecuredClusterServices.targetRevision | string | `"73.1.0"` | [stackrox/secured-cluster-services Helm chart](https://github.com/stackrox/helm-charts/tree/main/opensource) version |
