...
| secretsStoreCsiDriver.targetRevision | string | `"1.0.*"` | [vault-csi-provider Helm chart](https://github.com/kubernetes-sigs/secrets-store-csi-driver/blob/main/charts/secrets-store-csi-driver) version |
