...
**Homepage:** <https://github.com/adfinis-sygroup/helm-charts/tree/main/charts/storage-apps>
...
| cephCsiCephfs.targetRevision | string | `"3.5.*"` | [ceph-csi-cephfs Helm chart](https://github.com/ceph/csi-charts/tree/master/docs/cephfs) version |
